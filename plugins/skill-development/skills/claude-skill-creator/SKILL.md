...
description: Guide for creating effective Claude skills. Use when users want to create, update, package, or refine a Claude skill that extends Claude with focused knowledge, workflows, or tool integrations.
...
domains or tasks—they transform Claude from a general agent into a focused agent
equipped with procedural knowledge that no model can fully possess.

### What Skills Provide

1. Focused workflows - Multi-step procedures for specific domains
