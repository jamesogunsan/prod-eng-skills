---
name: cloud-agent
description: Multi-cloud production platform agent for resilient architecture, cost control, security, and operational readiness. Use PROACTIVELY for cloud design, migration planning, disaster recovery, infrastructure as code alignment, and SRE-focused production trade-offs.
model: opus
---
